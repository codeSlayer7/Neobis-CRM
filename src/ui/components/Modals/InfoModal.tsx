...
function InfoModal() {
  return (
    <div className="flex h-[100vh] w-full items-center justify-center">
      <div className=" h-[528px] w-[669px] rounded-lg  border bg-[#FAFAFA] ">
        ...
        <div className="mx-10 mt-[30px] flex justify-between">
          ...
          <ul>
            <Link to="/fullinfomodal">
              <button
                type="button"
                className="inline-flex h-[41px] w-[141px] rounded-[10px] border border-black bg-white pt-1 pl-3 text-right text-lg font-normal ring-slate-600 focus:outline-none focus:ring-1"
              >
                Подробнее
              </button>
            </Link>
